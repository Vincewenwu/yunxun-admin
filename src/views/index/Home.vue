  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="header">
      <el-col :span="10" class="logo" :class="collapsed?'logo-collapse-width':'logo-width'">
        <img src="../../assets/log.png" style="width:50px;height: auto" />云贝贝
      </el-col>
      <el-col :span="2">
      ...
      <el-col :span="4" class="userinfo">
        <el-dropdown trigger="hover">
          <span class="el-dropdown-link userinfo-inner"><img src="../../assets/user.png" /> {{ sysDatas.username }}</span>
    ...
    <el-col :span="24" class="main">
      <aside :class="collapsed?'menu-collapsed':'menu-expanded'" style="height:100%;">
        ...
        <el-menu default-active="2" class="el-menu-vertical-demo el-menu-other-style" unique-opened router><!--@open="handleOpen" @close="handleClose"-->
          <el-submenu v-for="item in menuDatas" :index="item.id">
            <template slot="title"><i class="el-icon-message"></i>{{ item.name }}</template>
            <el-menu-item v-for="modular in item.roleModular" :index="modular.url"><i class="el-icon-caret-right"></i>{{ modular.name }}</el-menu-item>
          </el-submenu>
          <!--<el-submenu index="1">
            <template slot="title"><i class="el-icon-message"></i>园所管理</template>
              <el-menu-item index="/schoollist">园所信息</el-menu-item>
              <el-menu-item index="/mailboxlist">信箱管理</el-menu-item>
          </el-submenu>
          <el-submenu index="2">
            <template slot="title"><i class="el-icon-message"></i>年级管理</template>
             <el-menu-item index="/gradeList">年级列表</el-menu-item>
             <el-menu-item index="/classList">班级列表</el-menu-item>
             <el-menu-item index="/babyClass">班级宝贝</el-menu-item>
             <el-menu-item index="/TeacherClass">班级教师</el-menu-item>
             <el-menu-item index="/campusInformationList">班级动态</el-menu-item>
          </el-submenu>
          <el-submenu index="3">
            ...
            <el-menu-item index="/thematicActivitiesEnroll">活动报名表管理</el-menu-item>
            <el-menu-item index="/baseparentingknowledgelist">育儿知识列表</el-menu-item>
          </el-submenu>
          <el-submenu index="4">
            <template slot="title"><i class="el-icon-message"></i>教师管理</template>
            <el-menu-item index="/teacherlist">教师列表</el-menu-item>
            <el-menu-item index="/dutiesList">职务列表</el-menu-item>
          </el-submenu>
          <el-submenu index="5">
          ...
          <el-submenu index="7">
            ...
            <el-menu-item index="/nutritionrecipesEveryDay">每周菜谱</el-menu-item>
          </el-submenu>
          <el-submenu index="8">
            ...
            <el-menu-item index="/parentEvlList">家长评价信息</el-menu-item>
            <el-menu-item index="/teacherEvlList">教师评价信息</el-menu-item>
          </el-submenu>
          <el-submenu index="9">
            <template slot="title"><i class="el-icon-message"></i>通知管理</template>
            <el-menu-item index="/platformlist">平台信息</el-menu-item>
            <el-menu-item index="/">消息提醒</el-menu-item>
          </el-submenu>
          <el-submenu index="10">
            <template slot="title"><i class="el-icon-message"></i>订单管理</template>
            <el-menu-item index="/basecombo">套餐管理</el-menu-item>
  ...
  export default {
    data () {
      return {
        ...
        sysDatas: JSON.parse(getStore('userInfo')),
        menuDatas: JSON.parse(getStore('userResouce'))
      }
    },
    methods: {
    }
