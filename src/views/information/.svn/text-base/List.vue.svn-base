<template>
  <el-row>
  <el-col :span="24">
  	<div style="font-size: 16px;margin-top: 10px;">校园资讯列表 记录（）</div> 
  </el-col>
  <el-col :span="24" class="border">  
	 <el-form :inline="true" :model="formInline">
      ...
      <el-button type="danger" @click="delShoolinfo" class="el-icon-delete"> 下架</el-button>
      <el-button type="success" @click="CheckTShoolinfo" class="el-icon-check"> 审核通过</el-button>
      <el-button type="warning" @click="CheckFShoolinfo" class="el-icon-close"> 审核不通过</el-button>
    </span>
	</el-form>
  </el-col>
...
// 编辑
      editoppen (id) {
        this.$router.push({ path: '/itedit', query: {id: id} })
      },
// 删除shoolinof
      async delShoolinfo () {
        var count = 0
